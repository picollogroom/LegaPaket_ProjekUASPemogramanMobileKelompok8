...
class activity_buat_resi : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_buat_resi)
    ...
    private fun muatMember() {
        lifecycleScope.launch {
            try {
                ...
                spinnerMember.adapter = ArrayAdapter(this@activity_buat_resi, android.R.layout.simple_spinner_dropdown_item, nama)
            } catch (e: Exception) {
                Toast.makeText(this@activity_buat_resi, "Gagal memuat data member", Toast.LENGTH_SHORT).show()
            }
        }
    }
    ...
    private fun buatResi() {
        ...
        lifecycleScope.launch {
            try {
                ...
                AlertDialog.Builder(this@activity_buat_resi)
                ...
                Toast.makeText(this@activity_buat_resi, e.message ?: "Gagal membuat resi", Toast.LENGTH_SHORT).show()
